...
if __name__ == '__main__':
    ...
    JBMS = jbms.split(' ')
    p1_keywords = '/编辑距离/data/P11_keywords.txt'
    p2_keywords = '/编辑距离/data/P12_keywords.txt'
    p1_keywords_new='/编辑距离/data/P11_keywords_new.txt'
